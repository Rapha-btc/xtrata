;; ==========================================================================
;; RENDEZVOUS INVARIANTS for pepe-4ever-fakfun
;; Appended by pepe-4ever-fakfun.build.sh to the local-alias fuzz build
;; (MASTER -> .xtrata-v3-2-3, SOURCE -> .bitcoin-pepe, free-threshold -> 0 so
;; fee-for always exercises the fee/discount regime).
;;
;; pepe-4ever-fakfun == xtrata-fakfun-forever-v2 EXCEPT for `inscribe`:
