...
(define-constant MAX-SMALL-BATCH-SIZE u32)      ;; 32 x 16 KiB  = 512 KiB

(define-constant MAX-STANDARD-BATCH-SIZE u8)   ;; 8 x 64 KiB   = 512 KiB

(define-constant MAX-MAXIMUM-BATCH-SIZE u4)    ;; 4 x 128 KiB  = 512 KiB
  ...
  (begin
    ...
    (let (
      ...
      (begin
        ...
        (asserts! (> batch-len u0) ERR-INVALID-BATCH)
        (asserts! (<= batch-len MAX-SMALL-BATCH-SIZE) ERR-INVALID-BATCH)
