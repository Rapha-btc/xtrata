...
import { onRequest as __collections_index_ts_onRequest } from "/Users/melophonic/Documents/GitHub/xtrata/xtrata-1.0/functions/collections/index.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__collections_index_ts_onRequest],
    },
  ]