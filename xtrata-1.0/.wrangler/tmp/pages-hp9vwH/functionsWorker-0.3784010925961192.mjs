...
// lib/db.ts
var resolveDb = /* @__PURE__ */ __name((env) => {
...
// lib/collections.ts
var slugPattern = /^[a-z0-9-]{3,64}$/;
var normalizeSlug = /* @__PURE__ */ __name((value) => value.trim().toLowerCase().replace(/[^a-z0-9-]/g, "-"), "normalizeSlug");
var isValidSlug = /* @__PURE__ */ __name((value) => slugPattern.test(value), "isValidSlug");
var staysWithinLimit = /* @__PURE__ */ __name((currentBytes, upcomingBytes, limitBytes) => currentBytes + upcomingBytes <= limitBytes, "staysWithinLimit");
...
var parseMetadata = /* @__PURE__ */ __name((raw) => {
  if (!raw) {
    return null;
  }
...
var onRequest2 = /* @__PURE__ */ __name(async ({ request, env, params }) => {
  ...
  if (request.method === "POST") {
    try {
      ...
      if (target === "published") {
        const collectionResult = await env.DB.prepare("SELECT * FROM collections WHERE id = ?").bind(collectionId).all();
...
var onRequest4 = /* @__PURE__ */ __name(async ({ env, params }) => {
  const collectionId = params?.collectionId;
  if (!collectionId) {
...
var getTargetBase = /* @__PURE__ */ __name((network) => {
  if (network === "mainnet") {
...
var countRows = /* @__PURE__ */ __name(async (env, table) => {
  const result = await queryAll(
    env,
...
var onRequest6 = /* @__PURE__ */ __name(async ({ env }) => {
  try {
...
var parseMetadata2 = /* @__PURE__ */ __name((value) => {
  if (!value) {
    return null;
  }
  try {
...
var onRequest7 = /* @__PURE__ */ __name(async ({ request, env, params }) => {
  const collectionId = params?.collectionId;
  if (!collectionId) {
...
// bns/[[path]].ts
var DEFAULT_BNS_BASE = "https://api.bns.xyz";
var onRequest8 = /* @__PURE__ */ __name(async (context) => {
  ...
  const pathParam = params.path;
  const path = Array.isArray(pathParam) ? pathParam.join("/") : pathParam ?? "";
  const targetBase = env.BNS_API_BASE || env.BNS_API_MAINNET || env.VITE_BNS_API_MAINNET || env.VITE_BNS_API_BASE || DEFAULT_BNS_BASE;
  const targetUrl = `${targetBase}/${path}${url.search}`;
  const headers = new Headers(request.headers);
  headers.delete("host");
  headers.delete("origin");
...
// collections.ts
var parseMetadata3 = /* @__PURE__ */ __name((value) => {
  if (!value) {
    return null;
  }
  try {
...
// ../.wrangler/tmp/pages-hp9vwH/functionsRoutes-0.5275854540565339.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-9TRkci/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-9TRkci/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3784010925961192.mjs.map
