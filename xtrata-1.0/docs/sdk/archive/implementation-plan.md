...
| 2026-05-30-01 | Robust independent reconstruction engine (batch reads, fallback sources, diagnostics, CLI reuse) | yes | reconstruction batch/fallback/strict tests + SDK helper/export tests + SDK gates (`sdk:typecheck`, `sdk:build`, `sdk:test`, `sdk:docs:validate`) | `docs/reconstruction-spec.md`, `docs/sdk/quickstart-reconstruction.md`, `docs/sdk/api-overview.md`, `docs/sdk/compatibility-matrix.md`, `packages/xtrata-reconstruction/README.md`, `docs/sdk/changelog.md` | pass | Codex |
