...
│  4. Call begin-or-get (pays begin fee)           │
│  5. Call add-chunk-batch (no fee, repeat)        │
│  6. Call seal-inscription (pays seal fee)         │
│  7. Verify inscription indexed on-chain          │
└──────────────────────┬──────────────────────────┘
                       │ Stacks contract calls
                       ▼
┌─────────────────────────────────────────────────┐
│     Xtrata Smart Contract (xtrata-v2-1-0)       │
│                                                  │
