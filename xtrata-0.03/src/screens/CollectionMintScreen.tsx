...
export default function CollectionMintScreen(props: CollectionMintScreenProps) {
  ...
  const startBatchMint = async () => {
    ...
    setSealState('idle');
    appendLog(`Starting batch mint (${items.length} items).`);
      ...
      <div className="panel__header">
        <div>
          ...
          <p className="meta-value">
            Batch mint uses the core contract. If the core contract is paused,
            only the owner can mint.
          </p>
          <p className="meta-value">
            This module mints directly into the core contract. Use Collection mint
            admin for partner collection contracts.
          </p>
        </div>
