...
import { loadMarketIndexSnapshot, saveMarketIndexSnapshot } from './cache';
import type { MarketActivityEvent, MarketIndexSnapshot } from './types';
...
const parseMarketEvent = (event: HiroContractEvent): MarketActivityEvent | null => {
  ...
  try {
    ...
    logWarn('market', 'Failed to parse market event', {
